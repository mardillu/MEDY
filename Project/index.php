...
<html lang="">
	...
	<body>
      ...
      include "header2.php";
    ?>
		<div id="login" style="width: 50%; margin-left: 25%; margin-top: 5%">
		<form action="admin/dashboard.php" method="post" accept-charset="utf-8">
            <table class="table table-bordered">
            	...
            	<tbody>
            		...
            		<tr>
            			<td> 
            				<a href="hregister.php" class="btn btn-default white" style="width: 100%; color:blue">Register a hospital</a>
            			</td>
            		</tr>
            	</tbody>
            </table>
