          ...
          <span class="white-text">
              ...
              <form action="" method="post" accept-charset="utf-8">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input type="text" class="form-control" placeholder="Second Name" aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Email</span>
                  <input type="email" class="form-control" placeholder="Last Name" aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input type="text" class="form-control" placeholder="Name of hospital..." aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Specialization</span>
                  <input type="text" class="form-control" placeholder="E.g Dentistry..." aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Adrress</span>
                  <input type="text" class="form-control" placeholder="Address line 1..." aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Address</span>
                  <input type="text" class="form-control" placeholder="Address line 2..." aria-describedby="sizing-addon1">
                </div><br>
        ...
        <div class="card-panel">
          <span class="white-text">
              ...
              <form action="" method="post" accept-charset="utf-8">
                  ...
                  <input type="text" class="form-control" placeholder="Name of your hospital" aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Address</span>
                  <input type="text" class="form-control" placeholder="Address line 1" aria-describedby="sizing-addon1">
                ...
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Email</span>
                  <input type="text" class="form-control" placeholder="Contact email..." aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Phone</span>
                  <input type="text" class="form-control" placeholder="Contact phone number..." aria-describedby="sizing-addon1">
                </div><br>
                <div class="input-group input-group-sm">
                  <span class="input-group-addon" id="sizing-addon1">Website</span>
                  <input type="text" class="form-control" placeholder="https://www.example.com" aria-describedby="sizing-addon1" value="https://www">
                </div>
                </form>
          </span>
        </div>
